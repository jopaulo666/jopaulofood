...
public class InsertDataForTesting {
	...
	private Restaurante[] restaurantes() {
		...
		r.setCnpj("10.245.857/0001-52");
		r.setTaxaEntrega(BigDecimal.valueOf(3.2));
		r.setTelefone("(91) 98541-8574");
		...
		r.setSenha(StringUtils.encrypt("r"));
		r.setCnpj("20.321.587/0001-50");
		r.setTaxaEntrega(BigDecimal.valueOf(4.5));
		r.setTelefone("(91) 98452-7401");
		r.getCategorias().add(categoriaSanduiche);
		r.getCategorias().add(categoriaSobremesa);
		...
		r.setSenha(StringUtils.encrypt("r"));
		r.setCnpj("10.654.854/0001-85");
		r.setTaxaEntrega(BigDecimal.valueOf(12.2));
		r.setTelefone("(91) 98547-1020");
		r.getCategorias().add(categoriaSanduiche);
		r.getCategorias().add(categoriaSobremesa);
		...
		r.setSenha(StringUtils.encrypt("r"));
		r.setCnpj("10.014.854/0001-85");
		r.setTaxaEntrega(BigDecimal.valueOf(9.8));
		r.setTelefone("(91) 98541-8501");
		...
		r.setSenha(StringUtils.encrypt("r"));
		r.setCnpj("20.520.410/0001-50");
		r.setTaxaEntrega(BigDecimal.valueOf(14.9));
		r.setTelefone("(91) 98145-8503");
	...
	private Cliente[] clientes() {
		...
		c.setNome("João Paulo da Mata Mendes");
		c.setEmail("jp_cbc@hotmail.com");
		c.setSenha(StringUtils.encrypt("c"));
		c.setCep("66033-640");
		c.setCpf("931.740.632-72");
		c.setTelefone("(91) 98146-4025");
		clientes.add(c);
