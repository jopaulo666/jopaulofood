...
import br.com.jopaulofood.application.service.ImageService;
...
public class ImageController {
	...
	@GetMapping(path = "/imagens/{type}/{imgName}", produces = {MediaType.IMAGE_PNG_VALUE, MediaType.IMAGE_JPEG_VALUE})
	@ResponseBody
